...
const TIERS = [
  ...
  },
  {
    ...
    cadence: '/ month',
    features: [
      'Unlimited 4-phase Oracle analyses',
      'Oracle Deep — semantic graph search + RAG',
      'Smart Network Depth mode',
      'Exact price contribution per catalyst',
      'Full L3 catalyst detail access',
      'Real-time model updates',
      'Priority Oracle processing',
    ],
    highlight: true,
  ...
  },
  {
    ...
    features: [
      ...
      'PDF & document upload + AI analysis',
