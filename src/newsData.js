...
export const breakingNews = [
  ...
  },
  {
    ...
    category: "manufacturing",
    source: "Electrek / USA Today",
    timestamp: "Apr 7, 2026",
    url: "https://electrek.co/2026/04/01/tesla-model-s-x-production-over-only-inventory-left/",
  },
  {
    headline: "Optimus transitioning from tech prototype to mass-market product — Gen 3 silhouette revealed; Musk: 'walking around but needs finishing touches'; external deliveries late 2026",
    category: "robotics",
    source: "Not a Tesla App / AV Market Strategist",
    timestamp: "Apr 7, 2026",
  ...
  {
    headline: "Tesla Germany registrations quadruple to 9,252 units in March — best March ever, +315% YoY; Q1 2026 already 66% of full-year 2025 volume",
    category: "product",
    source: "EVwire / KBA",
    timestamp: "Apr 7, 2026",
  ...
  {
    headline: "Tesla quietly becoming a global utility — Megapack 3 & Megablock production at Megafactory Houston; Q1 energy storage deployments reach 8.8 GWh",
    category: "energy",
    source: "24/7 Wall St.",
    timestamp: "Apr 6, 2026",
