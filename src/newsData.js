...
export const breakingNews = [
  ...
  {
    headline: "Molotov cocktail hurled at Tesla New Orleans sales office — latest anti-Tesla incident amid ongoing Musk/DOGE backlash; ATF + NOPD investigating; no arrests; brand risk intensifying",
    category: "corporate",
    source: "USA Today",
    timestamp: "Apr 16, 2026",
  ...
  {
    headline: "Optimus Gen 3 enters mass production era — factory deployment at Giga Texas + GigaShanghai; Tesla China president Wang Hao: 1M units/year long-term capacity target; 2026 volume ramp confirmed",
    category: "robotics",
  ...
  {
    headline: "AI5 chip taped out Apr 15 — Musk: 'radical simplicity'; engineering samples at Samsung Korea; AI5 targets Optimus + supercomputer clusters NOT vehicles; AI6 + Dojo3 also confirmed in pipeline",
    category: "robotics",
  ...
  },
  {
    ...
    category: "financials",
    source: "CNBC / QuiverQuant",
    timestamp: "Apr 15, 2026",
    url: "https://www.cnbc.com/2026/04/15/tesla-tsla-stock-analyst-upgrade-software-updates.html",
  },
  {
    headline: "Spring 2026 OTA rolling out — standalone FSD Self-Driving subscription app, 'Hey Grok' xAI voice assistant, Pet Mode, 24-hr dashcam; available to all AI4 vehicles globally",
    category: "product",
