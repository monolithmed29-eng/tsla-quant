export const catalysts = [
  ...
  },
  {
    ...
    updated: "Jun 29, 2026",
    description: [
      "🆕 Jun 29, 2026: Tesla launches FSD v14 Lite for HW3 hardware TODAY (build 2026.20.5.1) — first FSD update for HW3 vehicles in ~14 months; Tesla distilled HW4 v14 intelligence into legacy hardware via model distillation technique (HW3 has only ~15% of HW4's effective memory bandwidth); includes RL improvements and offline model upgrades from HW4 branch; early access rollout live, broader fleet rollout pending initial validation; Musk confirmed on X; Elluswamy's end-of-June timeline commitment fulfilled exactly on schedule; HW3 is supervised-only — not a path to unsupervised FSD, but validates Tesla's ability to extend the AI4 architecture to legacy hardware at scale (notateslaapp / Musk on X)",
