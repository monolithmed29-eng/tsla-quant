export const catalysts = [
  ...
  // ROBOTICS / AI
  {
    ...
    updated: "Apr 17, 2026",
    description: [
      "🆕 Apr 17, 2026: Tesla files Optimus Gen 3 mechanical blueprint patents — reveals new joint designs, actuator architecture, and chassis geometry optimized for mass manufacturing; blueprint filing signals production design is locked in and Gen 3 is no longer in prototype phase",
  ...
  // FINANCIALS
  {
    ...
    description: [
      ...
      "⚠️ TSLA down ~23% YTD (Apr 8, 2026) — trading ~$337–$363 range; ongoing pressure from inventory overhang and bear analyst calls; premarket +5% today on TSLA bounce",
      "⚠️ JPMorgan (Apr 8, 2026): Ryan Brinkman cuts Q1 EPS est. to $0.30 (from $0.43) and full-year 2026 to $1.80 (below Street consensus $1.95); Underweight/$145 PT maintained",
      "⚠️ JPMorgan (Apr 6, 2026): Underweight reiterated, $145 PT (Dec 2026) — 60% downside cited; record 50K+ inventory build central to bear case; analyst Ryan Brinkman",
  ...
  // ENERGY
  {
    ...
    description: [
      ...
      "🆕 Megapack 3 announced (Apr 7, 2026) — next-gen utility storage product; signals continued energy roadmap investment",
    ]
  },
  {
