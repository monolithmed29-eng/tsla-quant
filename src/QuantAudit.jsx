  ...
  return (
    <div style={{ fontFamily: F, background: '#030608', borderTop: '1px solid #0d1117' }}>
      ...
      {status === 'done' && results.length > 0 && (
        <div style={{ padding: pad, boxSizing: 'border-box', width: '100%', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            {results.map((r, i) => (
              <div key={i} style={{
                ...
                padding: isMobile ? '14px 16px' : '18px 20px', borderRadius: '3px',
              }}>
                {/* Strategy + score */}
          ...
          {/* Disclaimer */}
          <div style={{ fontSize: '9px', color: '#666', marginTop: '16px', lineHeight: 1.7, wordBreak: 'break-word' }}>
      ...
      {status === 'done' && results.length === 0 && (
        <div style={{ padding: pad, fontSize: '12px', color: '#888' }}>
